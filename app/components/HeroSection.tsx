...
const HeroSection: React.FC = () => (
    ...
    <div className="relative isolate overflow-hidden bg-slate-900 pt-16 pb-24 sm:pt-24 sm:pb-32">
      {/* Gradiente de Fundo Decorativo - Atualizado com cores da nova paleta e opacidade */}
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          // Gradiente ajustado de indigo-500 para purple-800 com opacidade 25
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            {/* Botão principal com indigo-500, hover indigo-600 */}
            ...
            {/* Link "Saber Mais" com slate-100 e hover indigo-400 */}
